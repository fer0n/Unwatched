...
public enum UnwatchedSchemaV1p13: VersionedSchema {
    public static let versionIdentifier = Schema.Version(1, 13, 0)
    ...
    public final class Subscription {
        ...
        public init(videos: [Video] = [],
            ...
            self._videoPlacement = videoPlacement.rawValue
